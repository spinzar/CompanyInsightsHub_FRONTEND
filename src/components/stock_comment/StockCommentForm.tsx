...
type Props = {
    symbol: string,
    handleComment: (event: CommentFormInputs) => void
};
...
const validation = Yup.object().shape({
    title: Yup.string().required("provide a title to your comment"),
    content: Yup.string().required("you must write your comment here...")
});
